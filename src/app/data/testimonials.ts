...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    quote:
      'The renewal of our website by Jonas has led to a verifiable rapid increase in the number of visits. Likewise, feedback from our customers confirmed that the web app is designed in a professional and user-friendly manner.',
    name: 'Norbert Driessen',
    jobTitle: 'CEO Thai Rin Ruam',
  },
  {
